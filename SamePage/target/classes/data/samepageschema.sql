...
=======
CREATE SCHEMA samepageschema;
CREATE DATABASE IF NOT EXISTS samepageschema;
USE samepageschema;
...
DELETE FROM Users;
INSERT INTO Users (Username, Email, UserPassword) VALUES ('TestUser','testuser@mail.com','testPassword');
